function [throughput, ber, MCS, snrMeasured] = simulate_extended_algorithm(bandwidth, model, distance)
...
for numPkt = 1:numPackets 
    ...
    cfgVHT.MCS = extended_algorithm(bandwidth, snrMeasured, numPkt); 
